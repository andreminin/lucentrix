...
public abstract class DocumentGenerator<T extends GeneratorModel> implements Iterator<ContentChange> {
    ...
    public ContentChange next() {
        ...
        ContentChange doc = generate();
        count.incrementAndGet();

        return doc;
    }

    protected abstract ContentChange generate();
